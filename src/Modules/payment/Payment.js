                    ...
                    <>
                        ...
                        <div className="flex flex-col text-center gap-5 p-6 my-5 shadow-xl border-black border-solid border rounded-xl">
                            <div>
                                ...
                                <p>{new Intl.NumberFormat('es-cl').format(contract.amountBenefit)}</p>
                                {contract.benefitRequest ? <p className="text-green-500">Cobrada</p> : <p className="text-red-500">Pendinte cobro</p>}
                            </div>
                            <div>
                                <p>Pendiente de pago: {new Intl.NumberFormat('es-cl').format(calculatePendingPrice())} </p>
